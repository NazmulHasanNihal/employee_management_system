...
const USERS: SeedUser[] = [
  ...
  // ═══════════════════════════════════════════════════════
  { name: 'Kamrul Hasan', email: 'kamrul.hasan@opshub.bd', role: 'Director', department: 'Engineering', designation: 'VP of Engineering', branch: 'Dhaka HQ', managerEmail: 'omar.kafi@opshub.bd', gender: 'Male', baseSalary: 140000, bloodGroup: 'O+', religion: 'Islam', phone: '+8801711000005', city: 'Dhaka', avatarBg: '7c3aed' },
  { name: 'Sharmin Sultana', email: 'sharmin.sultana@opshub.bd', role: 'Director', department: 'Product', designation: 'VP of Product', branch: 'Dhaka HQ', managerEmail: 'omar.kafi@opshub.bd', gender: 'Female', baseSalary: 130000, bloodGroup: 'A-', religion: 'Islam', phone: '+8801711000006', city: 'Dhaka', avatarBg: '7c3aed' },
  { name: 'Md. Zahidul Haque', email: 'zahidul.haque@opshub.bd', role: 'Director', department: 'Sales', designation: 'Director of Sales', branch: 'Dhaka HQ', managerEmail: 'musrat.gungun@opshub.bd', gender: 'Male', baseSalary: 125000, bloodGroup: 'B+', religion: 'Islam', phone: '+8801711000007', city: 'Dhaka', avatarBg: '059669' },
  { name: 'Nusrat Jahan Nishi', email: 'nusrat.nishi@opshub.bd', role: 'Director', department: 'Marketing', designation: 'Director of Marketing', branch: 'Dhaka HQ', managerEmail: 'musrat.gungun@opshub.bd', gender: 'Female', baseSalary: 120000, bloodGroup: 'O-', religion: 'Islam', phone: '+8801711000008', city: 'Dhaka', avatarBg: '059669' },
  { name: 'Jamal Uddin Ahmed', email: 'jamal.uddin@opshub.bd', role: 'Director', department: 'Operations', designation: 'Director of Operations', branch: 'Dhaka HQ', managerEmail: 'musrat.gungun@opshub.bd', gender: 'Male', baseSalary: 115000, bloodGroup: 'A+', religion: 'Islam', phone: '+8801711000009', city: 'Dhaka', avatarBg: '059669' },
  ...
  { name: 'Shafiqul Islam', email: 'shafiqul.islam@opshub.bd', role: 'Director', department: 'Finance', designation: 'Director of Finance', branch: 'Dhaka HQ', managerEmail: 'lutfar.rahman@opshub.bd', gender: 'Male', baseSalary: 117500, bloodGroup: 'O+', religion: 'Islam', phone: '+8801711000011', city: 'Dhaka', avatarBg: '0d9488' },
  { name: 'Syed Ashraful Haq', email: 'ashraful.haq@opshub.bd', role: 'Director', department: 'Quality Control', designation: 'Director of Quality', branch: 'Dhaka HQ', managerEmail: 'musrat.gungun@opshub.bd', gender: 'Male', baseSalary: 112500, bloodGroup: 'AB-', religion: 'Islam', phone: '+8801711000012', city: 'Dhaka', avatarBg: '059669' },
